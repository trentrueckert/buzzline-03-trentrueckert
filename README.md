...
py -m producers.json_producer_rueckert
```

## Start a JSON Consumer
...
```shell
.venv\Scripts\activate
py -m consumers.json_consumer_rueckert
```

## Start a CSV Producer
...
```shell
.venv\Scripts\activate
py -m producers.csv_producer_rueckert
```

## Start a CSV Consumer
...
```shell
.venv\Scripts\activate
py -m producers.csv_consumer_rueckert
```
